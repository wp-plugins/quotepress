...
class wpCSL_license__quotepress {    
    ...
    function add_licensed_package($params) {
        ...
        if (!isset($this->packages[$params['name']])) {
            $this->packages[$params['name']] = new wpCSL_license_package__quotepress(
                array_merge(
                    $params,
                    array(
                        'prefix' => $this->prefix,
...
/****************************************************************************
 **
 ** class: wpCSL_license_package__quotepress
 **
 **/
class wpCSL_license_package__quotepress {
